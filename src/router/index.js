...
export const constantRoutes = [
  ...
  // 管理
  {
    ...
    name: 'Assets',
    meta: { title: '资产管理', icon: 'el-icon-notebook-2' },
    children: [
      {
        path: 'asset',
        name: 'Asset',
        component: () => import('@/views/asset/index'),
        meta: { title: '资产列表', icon: 'el-icon-notebook-1' }
      },
      {
        path: 'item',
        name: 'Item',
      ...
      },
      {
        ...
        meta: { title: '功能列表', icon: 'el-icon-collection-tag' }
      },
      {
        path: 'domain',
        name: 'Domain',
        component: () => import('@/views/domain/index'),
        meta: { title: '域名管理', icon: 'el-icon-mobile' }
      }
    ]
  },
